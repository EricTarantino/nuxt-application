    ...
    <v-app>  
      <v-container fluid>
        <v-row justify="center">
          <femmltopbar @clicked="toggleComponent"/>
        </v-row>
        <!--
        <femdatachart v-if="showX"/>
        <femdatafilter v-if="showY"/>
        <femdatatable v-if="showZ"/>
        -->
      </v-container>
    </v-app>
  </div>
...
import Femmltopbar from '~/components/Femml_topbar.vue'
